-- =============================================================================
-- 00023_user_finance_state.sql — manual Finance dashboard state. Apply after
-- 00022_outcome_surveys_ownership. (Renumbered twice: 00021 and 00022 were
-- taken by calibration and outcome-surveys migrations that landed on main first.)
--
