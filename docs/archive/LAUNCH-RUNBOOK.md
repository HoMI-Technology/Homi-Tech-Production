...
| **Shadow share loop**    | Anonymous journey cards + dynamic OG unfurl; the viral exit for the top-of-funnel (mint endpoint later retired)                                | `app/shadow/[token]`, migration `00021`                                 |
