...
| `/admin/activity` | V4_PENDING | `app/(product)/admin/activity/page.tsx` | `buildAdminActivityV4View` | audit_log id/created_at/action_type/resource_type | HONEST | #416 | `__tests__/v4/admin-workspace.test.ts` | Covered by `/admin` prefix. Empty on loadError or []. No score column. Terminal stay-draft. |
| `/admin/ad-spend` | V4_PENDING | `app/(product)/admin/ad-spend/page.tsx` | `buildAdminAdSpendV4View` | ad_spend + profiles + payments | HONEST | #416 | `__tests__/v4/admin-workspace.test.ts` | Covered by `/admin` prefix. Empty on loadError or []. No score column. Terminal stay-draft. |
| `/admin/analytics` | V4_PENDING | `app/(product)/admin/analytics/page.tsx` | `buildAdminAnalyticsV4View` | PostHog getAnalyticsBundle | HONEST | #416 | `__tests__/v4/admin-workspace.test.ts` | Covered by `/admin` prefix. Empty on loadError or missing bundle. No score column. Terminal stay-draft. |
...
| `/admin/attribution` | V4_PENDING | `app/(product)/admin/attribution/page.tsx` | `buildAdminAttributionV4View` | profiles.attribution + assessments.attribution | HONEST | #416 | `__tests__/v4/admin-workspace.test.ts` | Covered by `/admin` prefix. Empty on loadError or []. No score column. Terminal stay-draft. |
