...
1. “Don’t fight Rocket Money” is directionally right but underspecified — users still expect _some_ recurring-spend awareness; the question is product identity, not absolute feature abstinence.
...
_(Full narrative body lives in the conversation response; this file is the durable index + critique register.)_
