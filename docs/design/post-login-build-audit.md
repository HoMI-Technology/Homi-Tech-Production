...
| Collapse `/plan` + `/results` | F8 / phase 07 | **Partial** — `/plan` + `/results` palette-only; Path in Measure; footer chip → Home; Path/employee/signals CTAs → Build; full `/results` page merge still open |
