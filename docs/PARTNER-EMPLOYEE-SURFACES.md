...
partner or employee fold hero. Path lives on personal Home.
...
### Partner
- Client emails
- Fake named roster from L0 invite traffic alone (named = `partner_id` roster only)
- Personal Path / Home fold as the partner instrument
- Equal marketing glass card wall competing with invite

### Employee
- Employer-named individual score theater for peers
- Six equal product cards as a second home
- Pretending the employer cannot see bands the product already aggregates
- Path as the employee hero (personal Home owns Path)

### Team
- Named individual scores or answer dumps
- Privacy theater that claims peers are invisible while listing them

---

## Aggregates / privacy rules
