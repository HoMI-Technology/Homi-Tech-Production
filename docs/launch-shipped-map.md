...
| **Shadow share loop**    | Anonymous journey cards + dynamic OG unfurl; the viral exit for the top-of-funnel (viewer reads `shadow_shares` directly; mint endpoint retired) | `app/shadow/[token]`, migration `00021`                                 |
