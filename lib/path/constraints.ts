 ...
 *
 * Ordered hard-stop resolution per the research (expert revision: "fix the
 * lowest readiness dimension first, driven by ordered hard stops"):
 *
 *   DTI_OVER_50 → HOUSING_RATIO_OVER_45 → RUNWAY_UNDER_1_MONTH → CREDIT_UNDER_620
 *
