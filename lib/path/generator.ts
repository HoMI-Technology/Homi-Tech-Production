...
> = {
  DTI_OVER_50: {
    title: "Bring monthly debt payments below the recorded DTI line",
    description:
  ...
  HOUSING_RATIO_OVER_45: {
    title: "Map the housing cost against the 45% line",
    description:
  ...
  RUNWAY_UNDER_1_MONTH: {
    title: "Build one month of emergency runway",
    description:
  ...
  CREDIT_UNDER_620: {
    title: "Build credit above the recorded 620 floor",
    description:
