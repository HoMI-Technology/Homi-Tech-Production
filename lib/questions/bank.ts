...
export const QUESTION_BANK: Question[] = [
  ...
  // F9: Pre-approval status /* brand-ok */
  {
    id: "fin_preapproval",
    dimension: "financial",
  ...
  // F15: Financial literacy confidence
  {
    ...
    dimension: "financial",
    category: "affordability",
    question_text: "How well do you understand mortgage terms (APR, points, escrow, amortization)?",
  ...
  // E2: Decision clarity
  {
    ...
    dimension: "emotional",
    category: "confidence",
    question_text: "How clear are you on what you want in a home (location, size, features)?",
    question_type: "slider",
  ...
  // E5: Partner/family alignment
  {
    ...
    dimension: "emotional",
    category: "alignment",
    question_text: "If purchasing with a partner or family, how aligned are you on the decision?",
    question_type: "single_choice",
    options: [
      {
        value: "fully_aligned",
  ...
  // E11: Compromise readiness
  {
    ...
    dimension: "emotional",
    category: "alignment",
    question_text: "How willing are you to compromise on your ideal home to fit your budget?",
    question_type: "slider",
    options: {
      min: 1,
      max: 10,
  ...
  // T6: Rental vs. ownership economics
  {
    ...
    dimension: "timing",
    category: "readiness",
    question_text: "How does your current rent compare to what your mortgage payment would be?",
    question_type: "single_choice",
    options: [
  ...
  // T8: Family planning impact
  {
    ...
    dimension: "timing",
    category: "life_stage",
    question_text: "How does your family situation affect the timing of this purchase?",
    question_type: "single_choice",
    options: [
      {
  ...
  // T9: Seasonal considerations
  {
    ...
    dimension: "timing",
    category: "market",
    question_text: "Have you considered how seasonality affects home buying in your area?",
    question_type: "single_choice",
    options: [
      {
  ...
  // T11: Economic outlook
  {
    ...
    dimension: "timing",
    category: "external",
    question_text: "How do you view the broader economic outlook for the next 1-2 years?",
    question_type: "single_choice",
    options: [
  ...
  // T12: Area development
  {
    ...
    dimension: "timing",
    category: "market",
    question_text: "Is the area you are looking at experiencing growth or development?",
    question_type: "single_choice",
    options: [
      {
        value: "strong_growth",
  ...
  // T13: Other financial goals timing
  {
    ...
    dimension: "timing",
    category: "readiness",
    question_text: "Do you have other major financial goals competing for your savings?",
    question_type: "single_choice",
    options: [
  ...
  // T14: Decision readiness window
  {
    ...
    dimension: "timing",
    category: "readiness",
    question_text: "If the perfect home appeared today at the right price, could you act on it?",
    question_type: "single_choice",
    options: [
...
export function getQuestionsByDimension(dimension: Dimension, decisionType: string): Question[] {
