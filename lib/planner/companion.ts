/* ------------------------------------------------------------------ */
/* Rule-based HōMI Companion — deterministic fallback voice from the   */
/* reference planner companion.ts (lib audit #5: PORT, wave 3), wired  */
/* to a live budget finance context. Pure module: no store imports.    */
...
/*      @/lib/score (the reference's 3-tier vocabulary was never       */
/*      adopted). Display labels resolve through VERDICT_META —        */
/*      e.g. ALMOST_THERE renders "ALMOST THERE" — never hardcoded.    */
...
/** Canon display label for a verdict key, resolved via @/lib/score meta. */
