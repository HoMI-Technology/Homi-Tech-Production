...
export const LENSES: LensDefinition[] = [
  ...
  // --- Financial Reality (housing) ---
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        cfmPath: "core.monthlyDebtPayments",
        fallback: 400,
        min: 0,
        max: 10000,
        step: 25,
    ...
    inputs: [
      {
        key: "rent",
        label: "Monthly rent",
        cfmPath: "housing.currentRent",
        writeBack: "currentRent",
        fallback: 2200,
        min: 500,
        max: 8000,
        step: 50,
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        cfmPath: "housing.currentMortgageBalance",
        writeBack: "currentMortgageBalance",
        fallback: 280000,
        min: 0,
        max: 2000000,
        step: 5000,
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        key: "currentRate",
        label: "Current rate",
        cfmPath: "housing.currentMortgageRatePct",
        writeBack: "currentMortgageRatePct",
        fallback: 7.5,
        min: 2,
        max: 12,
        step: 0.125,
  ...
  // --- Stability ---
  {
    ...
    chains: [{ lensId: "debt-payoff", pitch: "Free up outflow by killing a balance", carry: [] }],
  },
  {
    id: "debt-payoff",
    ...
    inputs: [
      {
        ...
        derive: (cfm) => Math.round(cfm.core.monthlyIncome.value * 0.85),
        fallback: 4500,
        min: 0,
        max: 20000,
        step: 100,
      ...
      },
      {
        ...
        derive: (cfm) => Math.round(cfm.core.monthlyIncome.value * 1.15),
        fallback: 6000,
        min: 0,
        max: 20000,
        step: 100,
      ...
      {
        key: "fixedCostsLow",
        label: "Monthly fixed costs (low)",
        derive: (cfm) => Math.round(monthlyOutflow(cfm) * 0.85),
        fallback: 2200,
        min: 0,
        max: 15000,
        step: 100,
      ...
      {
        key: "fixedCostsHigh",
        label: "Monthly fixed costs (high)",
        derive: (cfm) => Math.round(monthlyOutflow(cfm) * 1.15),
        fallback: 3000,
        min: 0,
        max: 15000,
        step: 100,
      ...
      {
        key: "savingsLow",
        label: "Liquid savings (low)",
        derive: (cfm) => Math.round(cfm.core.liquidSavings.value * 0.85),
        fallback: 6000,
        min: 0,
        max: 100000,
        step: 500,
      ...
      {
        key: "savingsHigh",
        label: "Liquid savings (high)",
        derive: (cfm) => Math.round(cfm.core.liquidSavings.value * 1.15),
        fallback: 10000,
        min: 0,
        max: 100000,
        step: 500,
    ...
    inputs: [
      {
        ...
        derive: (cfm) => monthlyOutflow(cfm) * 12,
        fallback: 48000,
        min: 12000,
        max: 200000,
        step: 1000,
      ...
      },
      {
        ...
        derive: investedOrMissing,
        writeBack: "investedAssets",
        fallback: 85000,
        min: 0,
        max: 2000000,
        step: 1000,
      ...
      {
        key: "expectedReturnPercent",
        label: "Expected annual return",
        cfmPath: "horizon.expectedReturnPct",
        fallback: 7,
        min: 2,
        max: 12,
        step: 0.5,
  ...
  },
  {
    ...
    chains: [{ lensId: "fire", pitch: "See the number this path is building toward", carry: [] }],
  },
  {
    id: "roth-conversion",
