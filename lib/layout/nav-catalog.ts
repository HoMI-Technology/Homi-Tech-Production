...
export const NAV_CATALOG: readonly NavCatalogEntry[] = [
  ...
  },
  {
    ...
    group: "Act",
    keywords: "architecture json prompt export scrape",
    flag: "agentOs",
    surfaces: { palette: true },
  },
  ...
  // Launch-hidden lab surface - route still exists; chrome off until verified.
  {
    href: "/simulator",
    label: "Simulator",
    paletteLabel: "Simulate your score",
    group: "Act",
    keywords: "what if test move",
  ...
  // Launch-hidden life labs
  {
    ...
    label: "Calendar",
    group: "Navigate",
    keywords: "milestones dates",
    surfaces: { palette: false },
  },
  {
    href: "/daily",
    label: "Daily Check-in",
    paletteLabel: "Daily check-in",
    group: "Act",
    keywords: "mood stress pulse",
    surfaces: { palette: false },
  },
  {
    href: "/credit",
  ...
  // Role dashboards + account (palette/switcher only - parity exceptions)
  {
    ...
    group: "Roles",
    keywords: "referral clients partner",
    surfaces: { palette: true },
  },
  {
  ...
  },
  {
    ...
    group: "Roles",
    keywords: "organization b2b aggregate",
    surfaces: { palette: true },
  },
  {
    href: "/admin",
    label: "Admin",
    group: "Roles",
    keywords: "platform users waitlist",
    surfaces: { palette: true },
  },
  {
    ...
    group: "Roles",
    keywords: "posthog funnel growth",
    surfaces: { palette: true },
  },
  {
    href: "/settings",
    label: "Settings",
    group: "Navigate",
    keywords: "account profile privacy security",
    surfaces: { palette: true },
  },
  {
