 ...
 * `/results` is a guest empty / LHCI shell (signed-in → Home). `/report/{id}` is the record.
 */
export const SURFACE_ROLES = {
  ...
  results: "Guest empty / LHCI shell only. Signed-in visits redirect to Home — not a Build destination.",
