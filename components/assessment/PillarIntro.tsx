...
export function PillarIntro({
  ...
  return (
    <div className="flex flex-col items-center py-12 text-center">
      ...
      >
        <span className="h-4 w-4 rounded-full" style={{ background: color, boxShadow: `0 0 12px ${color}` }} />
      </span>
      <p className="text-sm font-semibold uppercase tracking-widest" style={{ color }}>
        {name}
      </p>
      <h2 className="mt-3 font-display text-3xl font-semibold text-light sm:text-4xl">{question}</h2>
