...
import { HOME_V4_EMPTY_PATH_FOLLOW } from "@/lib/v4/home-state";
    ...
    >
      ...
      {view.pathPrimary ? (
        ...
        <>
          ...
          <p className="v4-support-follow">{HOME_V4_EMPTY_PATH_FOLLOW}</p>
          <Link href={V4_SHELL_ASSESS_HREF} className="v4-support-cta" data-home-v4-path-empty-cta="">
            Assess
            <ArrowRight aria-hidden className="size-3.5" strokeWidth={1.75} />
          </Link>
        </>
