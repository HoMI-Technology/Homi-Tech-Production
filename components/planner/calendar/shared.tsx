...
export const CARD = "card-chrome";
export const SUBCARD =
  "rounded-xl border border-white/[0.06] bg-navy/45 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]";

export const EYEBROW =
  "text-[0.6875rem] font-bold uppercase tracking-[0.14em] text-cyan";
export const EYEBROW_DIM =
  "text-[0.6875rem] font-bold uppercase tracking-[0.14em] text-dim";
  ...
  return (
    <div className={cn(CARD, "p-4 sm:p-5", className)}>
      <div className="mb-3.5 flex items-center gap-2">
        ...
        {count != null && (
          <span className="ml-auto flex h-5 min-w-5 items-center justify-center rounded-full border border-white/[0.08] bg-navy/50 px-1.5 font-score text-[10px] tabular-nums text-dim">
            {count}
          </span>
        )}
      </div>
