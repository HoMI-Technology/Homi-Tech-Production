...
export function HomeDensity({
  ...
  return (
    <div className="mt-3 w-full" data-home-density="">
      <section data-home-density-tools="" aria-label="Tools">
        ...
        <ul className="mt-2 grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-6" data-home-density-tools-grid="">
          {HOME_DENSITY_LENSES.map((lens) => (
            <li key={lens.id}>
              <Link
                href={lens.href}
                className="flex h-full items-center justify-between gap-2 rounded-xl border border-white/[0.03] bg-navy-light p-3"
      ...
      <div className="home-next-money mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
