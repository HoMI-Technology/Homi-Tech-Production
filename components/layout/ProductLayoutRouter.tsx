 ...
 *   - signed in              → AppSidebar rail + offset main
 *   - signed in, /assessment → AssessmentShell, full-bleed, no sidebar
 *
...
export function ProductLayoutRouter({
  ...
  return (
    <>
      ...
      />
      <main id="main" className="relative z-10 min-h-dvh pt-14 lg:pt-0 lg:pl-[72px] xl:pl-[248px]">
        {children}
      </main>
    </>
  );
