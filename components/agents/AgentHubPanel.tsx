  ...
  return (
    <div className="space-y-8">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-cyan/20 bg-gradient-to-br from-cyan/[0.07] via-navy to-emerald/[0.05] p-6 sm:p-8">
        ...
        />
        <p className="text-2xs font-semibold uppercase tracking-[0.2em] text-cyan">Agent Feed URL</p>
      ...
      <section className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 sm:p-8">
        <p className="text-2xs font-semibold uppercase tracking-[0.2em] text-emerald">Prompt Builder</p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <section className="rounded-2xl border border-white/5 bg-white/[0.02] p-6">
          <p className="text-2xs font-semibold uppercase tracking-[0.2em] text-amber">Registry levels</p>
      ...
      <section className="rounded-2xl border border-dashed border-white/10 bg-black/20 p-6 font-mono text-xs text-dim">
        <p className="mb-3 text-2xs font-semibold uppercase tracking-[0.2em] text-light">Agent recipes</p>
