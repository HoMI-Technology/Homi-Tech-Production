    ...
    <div className="field">
      <section className="mx-auto max-w-6xl px-6 pt-20 pb-16 md:pt-28">
        <div className="grid items-center gap-12 md:grid-cols-2">
          <Reveal>
            <p className="type-kicker text-emerald">Employee Benefit</p>
            <h1 className="mt-4 type-h1">The benefit that tells your people the truth.</h1>
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-dim">
              Your employer offers HōMI as a financial-wellness benefit — a private, honest
              readiness check for the decisions that keep people up at night. Buying a home. Moving.
              Making a leap.
            </p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <Reveal>
          <div className="glass grid gap-8 p-10 md:grid-cols-[1.1fr_1fr] md:items-center">
            <div>
              <p className="type-kicker text-cyan">Our privacy promise</p>
              <h2 className="mt-3 type-h2">
                Your employer never sees your individual results. Ever.
              </h2>
              <p className="mt-4 leading-relaxed text-dim">
                Employers can see that the benefit is being used and get an aggregate view of
                workforce readiness — never your score, never your verdict, never your answers. What
      ...
      <section className="mx-auto max-w-6xl px-6 pb-28">
        <Reveal>
          <div className="glass flex flex-col items-start gap-6 p-10 md:flex-row md:items-center md:justify-between">
            <div>
              <h2 className="type-h2">Your readiness, on your terms.</h2>
