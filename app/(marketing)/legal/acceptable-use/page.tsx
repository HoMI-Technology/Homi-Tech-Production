  ...
  return (
    <section className="px-6 py-16 md:py-24">
      <div className="mx-auto max-w-3xl">
        <h1 className="text-4xl font-black text-light">Acceptable Use Policy</h1>
        <p className="mt-3 text-sm text-dim">Last updated: July 2026</p>

        <div className="mt-10 space-y-10 text-dim">
          <div>
            <h2 className="text-xl font-bold text-light">1. Purpose</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-light">2. Prohibited Activities</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-light">3. Account Security</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-bold text-light">4. Content Standards</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-bold text-light">5. Enforcement</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-bold text-light">6. Reporting Violations</h2>
            <p className="mt-3 leading-relaxed">
