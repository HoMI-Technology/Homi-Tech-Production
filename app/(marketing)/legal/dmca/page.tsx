  ...
  return (
    <section className="px-6 py-16 md:py-24">
      <div className="mx-auto max-w-3xl">
        <h1 className="type-h1">DMCA Policy</h1>
        ...
        <div className="mt-10 space-y-10 text-dim">
          ...
          <div>
            <h2 className="type-h3">2. Reporting Copyright Infringement</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="type-h3">3. Designated Copyright Agent</h2>
            <p className="mt-3 leading-relaxed">
              Email:{" "}
          ...
          <div>
            <h2 className="type-h3">5. Repeat Infringers</h2>
            <p className="mt-3 leading-relaxed">
