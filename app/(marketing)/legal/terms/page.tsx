        ...
        <div className="mt-10 space-y-10 text-dim">
          <div>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              Companion, tools, or related services, you agree to these terms. If you
          ...
          <div>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              HōMI-Score, verdict, and any content from the Decision Companion are informational
              tools meant to help you understand your own readiness — they are not
              recommendations to buy, sell, borrow, or invest, and they are not a substitute
              for advice from a licensed professional.
            </p>
            <p className="mt-3 leading-relaxed">
              {BRAND.display} is not a lender, mortgage broker, registered investment
              advisor, credit bureau, real estate agent or brokerage, financial planner,
              bank, deposit institution, or product recommendation engine. See our{" "}
          ...
          <div>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              information when creating an account and keep it up to date. We may suspend or
          ...
          <div>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              canceled. You can cancel anytime from your account settings; cancellation
              takes effect at the end of the current billing period, and we do not provide
              partial refunds for unused time except where required by law.
            </p>
            <p className="mt-3 leading-relaxed">
              We may change pricing going forward. Existing subscribers will be notified of
              any pricing change before it takes effect on their next renewal.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              {BRAND.legalEntity}. Nothing in these terms transfers ownership of that
          ...
          <div>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              the service, including decisions you make based on your HōMI-Score or any
              content provided through the platform. You are solely responsible for your own
              financial decisions.
            </p>
          </div>
