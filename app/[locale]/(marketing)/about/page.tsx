      ...
      <section className="px-6 pb-16 pt-16 md:pt-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-dim">
            A Decision Companion. Built to answer one question: will you be okay?
          </p>
        </div>
      </section>
        ...
        <section className="px-6 py-16">
          <div className="mx-auto max-w-3xl space-y-6 text-lg leading-relaxed text-dim">
            ...
            <p>
              ...
              clarity, not pressure. HōMI is Decision Readiness Intelligence™ &mdash; the
              first platform that measures your true readiness for life&rsquo;s biggest
              decisions, starting with home buying.
            </p>
            <p>
          ...
          <div className="mx-auto max-w-3xl">
            <div className="glass p-10 md:p-14">
              ...
              <p className="mt-5 leading-relaxed text-dim">
                ...
                transaction. Nobody profits from helping you be ready. The entire financial
                industry profits when you say yes. That gap is why HōMI exists.
              </p>
              <p className="mt-5 leading-relaxed text-dim">
