...
export const SOURCE_LOCK_FACTS: SourceLockFact[] = [
  ...
  },
  {
    ...
    stringsMust: [
      "data-home-density",
      "data-home-density-money",
      "data-home-density-next",
      "data-home-density-tools",
  ...
  {
    id: "fold-wiring/home-density-lens-copy",
    file: "lib/dashboard/fold-truth.ts",
    identifiersMust: ["HOME_DENSITY_LENSES", "foldDensityPathTitles"],
    stringsMust: [
      "Housing tiers for your ledger",
      "Avalanche vs snowball paths",
      "Empty-ledger spending lens",
      "Simulated paths — educational",
      "/tools/affordability",
      "/tools/debt-payoff",
      "/tools/blind-budget",
      "/tools/monte-carlo",
