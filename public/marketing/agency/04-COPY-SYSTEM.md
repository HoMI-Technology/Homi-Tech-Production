# 04 · Copy system — ship these lines
...
Legal close (append near any product claim):
...
## Burst announcement (D-0 founder post)

Copy-paste. Image: `/marketing/content/posts/homi_post_launch_announcement_1080.png`

```
HōMI is live.

HōMI is the Decision Companion. Decision Readiness Intelligence™.
Everyone else tells you how. HōMI tells you if.

If you can maybe afford a major commitment — home first — and you are not sure you will be okay after, that is the question we built for.

Four honest reads: READY · ALMOST THERE · BUILD FIRST · DO NOT PROCEED.

Free Decision Readiness path · Plus $9.99 · Pro $24.99 · Family $39.99 / mo.
...
**“Are you a lender?”** — use [`../gtm/SUPPORT-ARE-YOU-A-LENDER.md`](../gtm/SUPPORT-ARE-YOU-A-LENDER.md) short reply.

**“Can you get me a better rate?”**

> We don’t shop rates or place loans. If you need a licensed lender, start there. If you want a readiness read before that pressure, the free path is here: [UTM]

**“Is this a credit score?”**

> No. HōMI does not replace a credit score. Credit does a real job. We ask a different question: will you be okay after the commitment?
...
## Rewrite table (banned → shippable)

Left column is what we **refuse**. Right column is what we **ship**. Do not publish the left column except in this internal table.

| Banned (never in posts, headlines, CTAs, subjects) | Shippable |
|----------------------------------------------------|-----------|
| revolutionary / game-changing / cutting-edge / disrupting | Built for one question: will you be okay after? |
| AI-powered | Decision Companion (the product is a readiness path — do not lead with the model) |
| Decision Intelligence OS | Decision Readiness Intelligence™ / Decision Companion |
| world's first / the first platform / the first system | HōMI is the Decision Companion. (No ordinal.) |
| the only platform | HōMI asks a different question than afford-only tools. |
| guaranteed / risk-free | (delete — do not soften into a promise) |
| dream home / unlock your dream home | the commitment you cannot undo / a home you might take on |
| pre-approval / pre-approved / approved / you qualify | readiness signal / educational exploration |
| bank-level | We take privacy and security seriously. |
| replaces your credit score | Answers a different question: readiness. |
| our lenders / best deal | (delete) |
| This is financial advice | Educational guidance only. |
