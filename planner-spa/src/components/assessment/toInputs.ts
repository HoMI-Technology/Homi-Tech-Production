// =============================================================================
// components/assessment/toInputs.ts — adapted from canon lib/questions/to-inputs.ts
// Maps canonical question-bank responses into OUR AssessmentInputs contract
// (@/lib/score). Choice→scale conversions are verbatim from canon.
// =============================================================================
...
type DeadlineOrigin = 'mine' | 'external' | 'none'

function urgencyToDeadlineOrigin(urgency: number): DeadlineOrigin {
...
/**
 * Maps canonical question-bank responses into the AssessmentInputs shape
 * consumed by our computeScore() — same mapping as canon
 * bankResponsesToInputs, minus the server-side conflict fields.
 */
export function bankResponsesToInputs(responses: Record<string, ResponseValue>): AssessmentInputs {
  ...
  return {
    ...
    deadlineOrigin: urgencyToDeadlineOrigin(urgency),
  }
}
