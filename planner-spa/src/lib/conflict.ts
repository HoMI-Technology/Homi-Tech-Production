/* ------------------------------------------------------------------ */
/* HōMI Conflict / Bias Layer — VERBATIM port of GitHub canon           */
/* lib/conflict/engine.ts (source of truth).                           */
/*                                                                     */
/* Pure, deterministic detector for outside pressure and conflict-of-  */
/* interest signals that sit alongside — and never influence — the     */
/* HōMI-Score itself. These signals never change score, verdict, or    */
/* hard-stops. They exist purely to surface honest context back to     */
/* the user: who benefits, whose deadline it is, and whether the       */
/* pressure they feel is actually theirs.                              */
/* ------------------------------------------------------------------ */
